  ...
  return (
    <div className="relative w-full h-[100dvh] bg-[#FAF7F2] flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        >
          {/* Confined to upper 25% area so glowing Ganesha idol at bottom is 100% visible! */}
          <div className="relative z-10 pt-14 sm:pt-16 space-y-2 max-w-sm mx-auto">
            <div className="flex items-center justify-center">
              <img src="/assets/ganesh.png" alt="Lord Ganesha" className="w-9 h-9 object-contain drop-shadow-md" />
            </div>
            <p className="font-cinzel text-xs sm:text-sm tracking-widest text-[#F7D070] font-bold uppercase drop-shadow-md">
              || श्री गणेशाय नमः ||
            </p>

            <h2 className="font-playfair text-4xl sm:text-5xl text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.85)] font-bold tracking-wide">
              Vinayak Sthapna
            </h2>
            ...
            <div className="space-y-1 font-cormorant text-white pt-1">
              ...
              <p className="text-sm sm:text-base text-[#F7D070] font-bold">
                (Breakfast : 09:00 AM Onwards)
              </p>
              <p className="font-cinzel text-xs sm:text-sm tracking-wider text-white/95 font-bold uppercase">
                Gloria Inn, Bhilwara
              </p>
            </div>
          </div>
        ...
        >
          ...
          <div className="relative z-10 pt-14 sm:pt-16 space-y-2 max-w-sm mx-auto">
            ...
            <p className="font-cormorant italic text-sm sm:text-base font-bold text-[#2C1518] max-w-xs mx-auto leading-snug">
            ...
            <div className="space-y-1 font-cormorant text-[#2C1518] pt-1">
              ...
              <p className="font-cinzel text-xs sm:text-sm tracking-wider text-[#5A121E] font-bold uppercase">
                Gloria Inn, Bhilwara
              </p>
            </div>
          </div>
        ...
        >
          {/* Tightly confined to upper chandeliers (top 26%) so dancing couple & glittering lehenga are 100% UNCOVERED! */}
          <div className="relative z-10 pt-14 sm:pt-16 space-y-2 max-w-sm mx-auto">
            <div className="flex justify-center">
              <img
                src="/assets/couple_logo_gold.png"
            ...
            <p className="font-cinzel text-xs sm:text-sm tracking-[0.25em] text-[#F7D070] font-bold uppercase drop-shadow-sm">
              THE SANGEET NIGHT
            </p>
            ...
            {/* Couplet — Compact elegant floating italic quote */}
            <p className="font-cormorant italic text-sm sm:text-base text-[#FFF9D2] max-w-xs mx-auto drop-shadow-[0_1px_4px_rgba(0,0,0,0.9)] pt-1 leading-snug">
        ...
        >
          ...
          <div className="relative z-10 pt-14 sm:pt-16 space-y-2 max-w-sm mx-auto">
            <div className="flex items-center justify-center">
              <img src="/assets/shubharambh.png" alt="|| शुभारंभ ||" className="h-9 w-auto object-contain drop-shadow-sm" />
            </div>
        ...
        >
          ...
          <div className="relative z-10 pt-14 sm:pt-16 space-y-2 max-w-sm mx-auto">
            <div className="flex justify-center">
              <img src="/assets/couple_logo.png" alt="A-अ" className="w-9 h-9 object-contain drop-shadow-sm" />
            </div>
            ...
            <div className="space-y-1 font-cormorant text-[#2C1518] pt-1">
              ...
              <p className="font-cinzel text-xs sm:text-sm tracking-wider text-[#8B6508] font-bold uppercase">
                Gloria Inn, Bhilwara
              </p>
            </div>
          </div>
        ...
        >
          ...
          <div className="relative z-10 pt-14 sm:pt-16 space-y-2 max-w-sm mx-auto">
            ...
            <h2 className="font-playfair text-3xl sm:text-4xl text-[#5A121E] font-bold drop-shadow-md tracking-wide">
              Milni, Badhai & Nikasi
            </h2>
            ...
            <div className="space-y-1.5 font-cormorant text-[#2C1518] pt-1">
              ...
              <div className="inline-flex flex-wrap items-center justify-center gap-2 bg-[#FAF7F2]/95 backdrop-blur-sm px-3.5 py-1.5 rounded-lg border border-[#D4AF37]/50 shadow-xs text-xs sm:text-sm font-bold">
        ...
        <section className="story-slide w-full h-[100dvh] snap-start relative flex flex-col justify-between p-6 sm:p-8 overflow-hidden text-center text-white select-none">
          ...
          <div className="relative z-10 pt-14 sm:pt-16 space-y-2 max-w-sm mx-auto">
            <div className="flex justify-center">
              <img src="/assets/couple_logo_gold.png" alt="A-अ" className="w-9 h-9 object-contain drop-shadow-md" />
            </div>

            <h2 className="font-playfair text-3xl sm:text-4xl text-gold-gradient font-bold drop-shadow-md tracking-wide">
              Reception & Sacred Pheras
            </h2>

            <div className="space-y-1.5 font-cormorant text-white pt-1">
              <p className="font-bold text-base sm:text-lg text-[#FFF5C0]">
                Saturday, 12th December 2026 • Gloria Inn, Bhilwara
              </p>

              {/* Compact horizontal chip */}
              <div className="inline-flex flex-wrap items-center justify-center gap-2 bg-black/65 backdrop-blur-md px-3.5 py-1.5 rounded-lg border border-[#D4AF37]/50 shadow-xs text-xs sm:text-sm font-bold">
            ...
            {/* Couplet */}
            <p className="font-cormorant italic text-sm sm:text-base text-[#FFF5C0] max-w-xs mx-auto drop-shadow-md pt-1 leading-snug">
